        ...
        for learning_rate in learning_rates:
            for latent_dims in latent_dims_list:
                for beta in betas:
                    ...
                    #==============================================================================
                    if sigmoid:
                        autoencoder = VAE_TwoParamsSigmoid(next(iter(train_loader))[0][1].shape, latent_dims, batch_size, labels).to(device)
                    else:
                        autoencoder = VAE_TwoParams(next(iter(train_loader))[0][1].shape, latent_dims, batch_size, labels).to(device)
                    #==============================================================================
                    # Train the model
                    #==============================================================================
